...
%
%   spneedlet_eval( j, x, B ) evaluates the spherical needlets psi_jk,
%   k=1,2,...,Npix, at the point x with the parameter B. x is a vector on
%   the sphere S^2. The return value psi_j is a column vector with length
%   Npix.
%
%   This function depends on pix2ang (in the package MEALPix) and
%   p_polynomial which is used to evaluate Legendre polynomials (written by
%   Theodore Chihara et al.)
%
