...
fod1_s = [0.7660 0  0.6428]; %%0,0,1; z-[0 0 1] [ sqrt(3)/2 0  1/2] [0.7071 0  0.7071] [1/2 0  sqrt(3)/2] [0.2588 0   0.9659] [sqrt(3)/2 0 1/2]
...
mean_angle2_SH_lmax8 = mean(angle1_SH_lmax8(nfib_SH_lmax8==2))*180/pi;
mean_angle2_sCSD_lmax8 = mean(angle1_sCSD_lmax8(nfib_sCSD_lmax8==2))*180/pi;
mean_angle2_sCSD_lmax12 = mean(angle1_sCSD_lmax12(nfib_sCSD_lmax12==2))*180/pi;
mean_angle2_sCSD_lmax16 = mean(angle1_sCSD_lmax16(nfib_sCSD_lmax16==2))*180/pi;
mean_angle2_SN = mean(angle1_SN(nfib_SN==2))*180/pi;
